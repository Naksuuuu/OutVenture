<div x-data="{ openDelete: false }">
    <button type="button" @click="openDelete = true"
        class="inline-flex items-center justify-center p-2 text-[11px] font-bold text-red-600 bg-white border border-red-200 rounded-md hover:bg-red-50 transition-all uppercase tracking-wider">
            ...
            <div
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500">This will also delete all size values in this group. This
