        ...
        <x-ui.card-item class="overflow-hidden" rounded="rounded-[2.5rem]" shadow="shadow-xl shadow-slate-200/50"
            ...
            <x-slot:header class="px-10 py-10 ">
                <div class="relative z-10 flex items-center gap-6">
                    ...
                    <div>
                        <h1 class="text-3xl font-black tracking-tight uppercase italic">Buat Grup Ukuran</h1>
                ...
                <div class="p-8 md:p-12">
                    <form wire:submit.prevent="save" class="space-y-10">
                            ...
                            <div class="space-y-8">
                                ...
                                <div class="space-y-4">
                                    @foreach ($sizeValues as $index => $sizeValue)
                                        <div
                                            class="flex items-center gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100 group hover:border-blue-100 transition-colors">
                                            <div
                        ...
                        <div class="pt-8 border-t border-slate-100">
                            <x-ui.button type="submit" variant="create-ghost" icon="check" label="Simpan Grup Ukuran"
