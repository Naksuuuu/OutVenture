<div class="py-12 px-4 sm:px-6">
    <div class="mx-auto">
        <div class="bg-white rounded-3xl shadow-[0_10px_40px_-15px_rgba(0,0,0,0.08)] border border-slate-100 overflow-hidden">

            <div class="glass-header px-8 py-8 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center space-x-4">
                    <div class="w-12 h-12 bg-black rounded-2xl flex items-center justify-center shadow-lg shadow-indigo-200">
                ...
                <div>
                    @if ($order->status_pembayaran)
                        <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold bg-emerald-100 text-emerald-800">
                ...
                <section>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 text-slate-800 shadow-inner">
                                {{ $order->user->name ?? 'N/A' }}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="w-full bg-slate-50 border-none rounded-2xl px-5 py-4 text-slate-800 shadow-inner font-semibold">
                ...
                <section>
                            ...
                            <div class="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm">
                                <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex flex-wrap gap-x-6 gap-y-2 text-[11px] font-bold uppercase tracking-widest text-slate-400">
                                            <span>Varian: <span class="text-slate-600">Variant</span></span>
                                            <span>Ukuran: <span class="text-slate-600">{{ $item->variantSpec->size->size_value ?? 'N/A' }}</span></span>
                                            <span class="flex items-center gap-1.5">
                                                Warna: 
                                                @if ($item->variantSpec->variant->color)
                                                    <div class="w-3 h-3 rounded-full border border-slate-200" style="background-color: {{ $item->variantSpec->variant->color->color_code }}"></div>
                                                    <span class="text-slate-600">{{ $item->variantSpec->variant->color->nama_color }}</span>
                                                @else
                                    ...
                                    <div class="flex flex-wrap items-center gap-8 lg:gap-12 border-t lg:border-t-0 pt-4 lg:pt-0">
                                        <div>
                                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Harga Satuan</p>
                                            <p class="text-slate-700 font-semibold text-sm">Rp {{ number_format($item->harga, 0, ',', '.') }}</p>
                                        </div>
                                        <div>
                                            <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Jumlah</p>
                                            <p class="text-slate-900 font-bold bg-slate-50 border border-slate-100 px-3 py-0.5 rounded-lg text-sm inline-block">
                                                {{ $item->quantity }}
                                            </p>
                                        </div>
                                        <div class="text-right">
                                            <p class="text-[10px] font-bold text-indigo-400 uppercase tracking-wider mb-1">Subtotal</p>
                    ...
                    <div class="mt-4 flex justify-end">
                        <div class="bg-indigo-600 rounded-2xl px-6 py-3 shadow-md flex items-center gap-4">
                            <span class="text-[10px] font-bold text-indigo-100 uppercase tracking-[0.2em]">Total Bayar</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="bg-indigo-50 rounded-2xl p-6 border border-indigo-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-[10px] font-bold text-indigo-600 uppercase tracking-wider">Total Item</p>
                                    <p class="text-xl font-bold text-indigo-900">{{ $order->items->sum('quantity') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="bg-emerald-50 rounded-2xl p-6 border border-emerald-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-[10px] font-bold text-emerald-600 uppercase tracking-wider">Total Jenis</p>
                        ...
                        <div class="bg-amber-50 rounded-2xl p-6 border border-amber-200">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-[10px] font-bold text-amber-600 uppercase tracking-wider">Total Jumlah</p>
