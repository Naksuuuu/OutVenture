<div x-data="{ openCreate: @entangle('isOpen').live }">
    ...
    <template x-teleport="body">
        <div x-show="openCreate" x-cloak class="fixed inset-0 z-[9999] overflow-y-auto">
                    ...
                    <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-white">
                        <div>
                            ...
                            <h3 class="text-lg font-bold text-slate-800">
                                Varian: {{ $variant->color->nama_warna ?? 'Tanpa Warna' }}
                            </h3>
                        </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" wire:model="stok" min="0" step="1"
                                        class="w-full bg-slate-50 border-none rounded-xl px-4 py-3 text-indigo-600 shadow-inner focus:ring-2 focus:ring-indigo-500/20 font-bold text-sm @error('stok') ring-2 ring-red-500/50 @enderror">
                                    @error('stok')
                                        <span
                                            class="text-red-500 text-[10px] font-bold mt-1 ml-1">{{ $message }}</span>
                                    @enderror
