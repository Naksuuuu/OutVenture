            ...
            <div @click.away="isOpen = false" x-transition:enter="transition ease-out duration-300"
                ...
                <form wire:submit.prevent="save" wire:loading.attr="disabled">
                    <div class="p-8 space-y-6">
                         <div>
                             <label class="block text-[11px] font-bold text-slate-500 uppercase mb-2 tracking-widest text-left">Ukuran</label>
                        ...
                        <div>
                            <label class="block text-[11px] font-bold text-slate-500 uppercase mb-2 tracking-widest text-left">Kode SKU</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="block text-[11px] font-bold text-slate-500 uppercase mb-2 tracking-widest text-left">Harga (Rp)</label>
                            ...
                            <div>
                                <label class="block text-[11px] font-bold text-slate-500 uppercase mb-2 tracking-widest text-left">Stok Unit</label>
