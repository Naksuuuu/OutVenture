        ...
        <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div class="p-3 bg-blue-50 rounded-xl text-blue-600">
                    {{-- <img src="/storage/tenda.jpg" alt=""> --}}
                </div>
                <span class="flex items-center text-xs font-medium text-green-600 bg-green-50 px-2 py-1 rounded-full">+2.5%</span>
            </div>
            <div class="mt-4">
                ...
                <div class="space-y-5">
                    @foreach ($bestSellingProducts as $product)
                        <div class="flex items-center group cursor-pointer">
                            <div class="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center text-gray-400 group-hover:bg-emerald-50 group-hover:text-emerald-500 transition-colors mr-4 overflow-hidden">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <div class="space-y-4">
                    <div class="flex items-start p-4 bg-red-50/50 rounded-xl border border-red-100">
                        <div class="flex-shrink-0 w-8 h-8 bg-red-100 text-red-600 rounded-lg flex items-center justify-center mr-3">
                            ⚠️
                        </div>
                        <div>
                    ...
                    <div class="flex items-start p-4 bg-emerald-50/50 rounded-xl border border-emerald-100">
                        <div class="flex-shrink-0 w-8 h-8 bg-emerald-100 text-emerald-600 rounded-lg flex items-center justify-center mr-3">
