    ...
    <div class="mx-auto">
        ...
        <div
            ...
            <form wire:submit="update">
                <div class="p-2 md:p-8 lg:p-10 space-y-6 md:space-y-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
                            ...
                            <div class="md:col-span-1">
                                ...
                                @if ($product->variants->count() > 0)
                                    <span class="text-red-400 text-[10px] mt-1 font-bold uppercase">Kategori tidak bisa
                                        diubah, karena produk memiliki variants</span>
                                @endif
                                @error('id_category')
                                    <span
                                        class="text-red-500 text-[10px] mt-1 font-bold uppercase">{{ $message }}</span>
                                ...
                                @forelse ($product->variants as $variant)
                                    <div
                                        ...
                                        <div class="bg-slate-50/80 px-6 py-4 border-b border-slate-100">
                                            <div
                                                class="flex flex-col md:flex-row md:flex-wrap md:items-center justify-between gap-4 mb-4">
                                                <div class="flex items-center space-x-2 md:space-x-4">
                                                    ...
                                                    @else
                                                        <div
                                                            ...
                                                            <x-lucide-image
                                                                class="w-6 h-6 md:w-8 md:h-8 text-slate-400" />
                                                        </div>
                                                    @endif
                                                    <div>
                                                        <label
                                                            ...
                                                            @foreach ($colors as $color)
                                                                @php
                                                                    $disabled =
                                                                        ...
                                                                        $color->id !== $variant->id_color; // disable if used by other variant
                                                                @endphp
                                                        ...
                                                        @if ($variant->specs->count() > 0)
                                                            <span
                                                                class="text-red-400 text-[10px] mt-1 font-bold uppercase block">Tidak
                                                                dapat mengubah warna, varian memiliki
                                                                spesifikasi.</span>
                                                        @else
                                                            <span
                                                                class="text-red-400 text-[10px] mt-1 font-bold uppercase block">Warna
                                                                yang dipakai varian lain dinonaktifkan.</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div
                                            ...
                                            <div class="border-t border-slate-200 pt-4">
                                                <label
                                                    ...
                                                    Gambar Baru</label>
                                                <input type="file"
                                                    wire:model="variant_new_images.{{ $variant->id }}"
                                                    accept="image/*"
                                                    ...
                                                    <tbody class="divide-y divide-slate-50">
                                                        @forelse ($variant->specs as $spec)
                                                            <tr>
                                                                ...
                                                                <td class="px-2 md:px-4 py-3">
                                                                    <span
                                                                        class="text-xs md:text-sm font-bold text-slate-800">
