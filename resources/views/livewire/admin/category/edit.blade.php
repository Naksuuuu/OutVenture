            ...
            <div class="px-10 py-10 border-b border-slate-50 bg-slate-900 text-white relative">
                <div class="relative z-10 flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-400 font-bold mt-1 tracking-wider uppercase text-xs">{{ $category->nama_category }}</p>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-8">
                            <div class="flex items-center gap-3 mb-2">
                                <span class="w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-black text-sm">01</span>
                            ...
                            <div class="group">
                                ...
                                @error('nama_category')
                                    <span class="text-rose-500 text-[10px] mt-2 font-black uppercase block">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="space-y-8">
                            <div class="flex items-center gap-3 mb-2">
                                <span class="w-8 h-8 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-black text-sm">02</span>
                                <h2 class="font-black text-slate-800 uppercase tracking-widest text-xs">Visual Kategori</h2>
                            </div>

                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <p class="text-[9px] font-black text-slate-400 uppercase mb-2 tracking-widest">Gambar Saat Ini</p>
                                    <div class="aspect-square rounded-2xl overflow-hidden bg-slate-50 border border-slate-100 shadow-inner flex items-center justify-center group relative">
                                        @if ($category->image)
                                            <img src="{{ asset('storage/' . $category->image) }}" class="w-full h-full object-cover opacity-60">
                                        @else
                                ...
                                <div class="relative group">
                                    <p class="text-[9px] font-black text-emerald-600 uppercase mb-2 tracking-widest">Upload Baru</p>
                                    <div class="aspect-square rounded-2xl overflow-hidden bg-emerald-50 border-2 border-dashed border-emerald-200 flex items-center justify-center transition-all group-hover:border-emerald-400 relative">
                                        @if ($new_image)
                                            <img src="{{ $new_image->temporaryUrl() }}" class="w-full h-full object-cover">
                                        @else
                                            <div class="text-center p-2">
                                                <svg class="w-8 h-8 text-emerald-300 mx-auto mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                                </svg>
                                                <span class="text-[8px] font-black text-emerald-400 uppercase tracking-tighter">Pilih File</span>
                                            </div>
                                        @endif
                            ...
                            <div wire:loading wire:target="new_image" class="flex items-center gap-2 text-[10px] font-black text-emerald-600 uppercase animate-pulse">
