<div x-data="{ openDelete: false }">
    ...
    <div x-show="openDelete" x-cloak x-transition:enter="transition ease-out duration-50"
        ...
        x-transition:leave-end="opacity-0" class="fixed inset-0 flex items-center justify-center p-4"
        style="z-index: 9999;">
        <div class="fixed inset-0 bg-slate-900/70 backdrop-blur-sm" @click="openDelete = false">
        </div>
        <div <div class="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-slate-100 p-6 space-y-4"
            style="z-index: 10000;">
            <div class="flex items-start space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500">Yakin ingin menghapus kategori ini? Data tidak bisa dikembalikan.
                    </p>
                </div>
            </div>
