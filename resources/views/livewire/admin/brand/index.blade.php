<div class="p-8 bg-slate-50/50 min-h-screen">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        @foreach ($brands as $brand)
            <div class="group relative bg-white rounded-[2rem] border border-slate-100 shadow-sm shadow-slate-200/40 hover:shadow-2xl hover:shadow-slate-300/50 hover:-translate-y-1 transition-all duration-500 overflow-hidden">
                
                <div class="absolute -right-6 -top-6 text-slate-50/50 group-hover:text-emerald-50 group-hover:rotate-12 transition-all duration-500">
                    <x-lucide-award class="w-32 h-32" />
                </div>

                <div class="relative flex items-center p-2 h-[160px] gap-6">
                    <div class="w-36 h-full bg-slate-50 rounded-[1.5rem] overflow-hidden flex items-center justify-center p-1 relative z-10 transition-transform duration-500 group-hover:scale-[0.98]">
                        @if ($brand->image)
                        ...
                        @else
                            <div class="flex flex-col items-center justify-center text-slate-300">
                                ...
                                <span class="text-[8px] font-black uppercase tracking-tighter opacity-40">No Image</span>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="flex-1 pr-4 flex flex-col justify-center relative z-10">
                        ...
                        <div class="space-y-1.5">
                            ...
                            @if ($brand->is_trusted)
                                <div class="flex items-center text-emerald-500 inline-flex px-2 py-0.5 bg-emerald-50 rounded-full w-fit border border-emerald-100/50">
                        ...
                        <div class="flex items-center mt-4 gap-1 opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
