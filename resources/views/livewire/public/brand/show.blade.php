<div class="w-full pb-10 flex flex-col items-center">
    ...
    <x-ui.hero :brands="collect([$brand])" />
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            @empty
                <div class="col-span-full">
                    <x-ui.empty-state full icon="shopping-bag" title="Produk Kosong"
                        message="Belum ada produk untuk brand ini dengan filter tersebut" padding="p-2" class="py-2!"
                        shadow="shadow-none" border="border-0" rounded="rounded-2xl" />
                </div>
            @endforelse
        </div>
        <div class="px-6 py-4 ">
