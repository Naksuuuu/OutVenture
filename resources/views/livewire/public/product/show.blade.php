        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-5 flex flex-col pt-4 lg:pt-0">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-[11px] text-gray-500 mt-3 italic">Catatan Ukuran: Model ini ukurannya besar. Pilih
                        ukuran
                ...
                <div class="border-t border-black">
                    ...
                    <div class="pb-8">
                        <p class="text-[13px] leading-relaxed text-gray-600 mb-4">
                            ...
                            berbeda tergantung pada cuaca dan aktivitas. Jaket shell GORE-TEX® kompatibel dengan jaket
                            liner
