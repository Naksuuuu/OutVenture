...
<div class="p-8 bg-gray-50 min-h-screen">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('admin.categories.create') }}" class="bg-emerald-500 text-white px-5 py-2.5 rounded-xl font-bold flex items-center hover:bg-emerald-600 transition shadow-lg shadow-emerald-100">
    ...
    <div class="mb-8 max-w-md">
        <div class="relative">
            ...
            <input type="text" placeholder="Search categories..." class="w-full pl-10 pr-4 py-2.5 border border-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white shadow-sm">
        </div>
    </div>
        ...
        <div class="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-md transition group">
            <div class="flex justify-between items-start mb-4">
                <div>
                    ...
                    <h3 class="text-xl font-bold text-gray-800 group-hover:text-emerald-600 transition">{{ $category->name_category }}</h3>
                    <p class="text-gray-400 text-sm mt-1 leading-relaxed">{{ Str::limit($category->description, 60) }}</p>
                </div>
                <div class="flex gap-2">
                    
                    <a href="{{ route('admin.categories.edit', $category->id) }}" class="p-2 text-gray-400 hover:text-emerald-500 hover:bg-emerald-50 rounded-lg transition">
                        ✏️
                    </a>
