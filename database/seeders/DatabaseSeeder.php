...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $users = [
            ...
            [
                'id' => 6,
                'nama_lengkap' => 'Admin Outventure 6',
                'email' => 'admin6@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 6, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 7,
                'nama_lengkap' => 'Admin Outventure 7',
                'email' => 'admin7@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 7, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 8,
                'nama_lengkap' => 'Admin Outventure 8',
                'email' => 'admin8@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 8, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 9,
                'nama_lengkap' => 'Admin Outventure 9',
                'email' => 'admin9@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 9, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 10,
                'nama_lengkap' => 'Admin Outventure 10',
                'email' => 'admin10@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 10, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 11,
                'nama_lengkap' => 'Admin Outventure 11',
                'email' => 'admin11@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 11, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 12,
                'nama_lengkap' => 'Admin Outventure 12',
                'email' => 'admin12@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 12, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 13,
                'nama_lengkap' => 'Admin Outventure 13',
                'email' => 'admin13@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 13, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 14,
                'nama_lengkap' => 'Admin Outventure 14',
                'email' => 'admin14@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 14, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
            [
                'id' => 15,
                'nama_lengkap' => 'Admin Outventure 15',
                'email' => 'admin15@outventure.com',
                'email_verified_at' => now(),
                'alamat' => 'Jl. Outdoor Adventure No. 15, Jakarta',
                'password' => bcrypt('admin123'),
                'role' => 'admin',
            ],
        ];
